	...
	<header>
		<div class="headerDiv">
			...
			<div class="wap-fn">
	            ...
	            <button type="button" class="toggleNavMenu" style="display: none">
		...
		<div class="videoCont">
				...
				<div id="sticker" class="rwd-video ">
					<div class="videoWrapper">
						...
						<iframe width="560" height="315" src="http://video-edit.phimedia.tv/index_embed_tba.php?layout=Y&src=http://pgd.waaarp.com/tbax/MMl6R0KO44U/45a19f70-8a44-421a-96e3-23cd0a250e89_240p_500k.mp4&title=建物瑕疵之侵權責任" frameborder="0" allowfullscreen></iframe>
						
						<div class="coverImg" style="cursor: pointer;"><img src="/webView/assets/imgs/cover2.jpg"></div>
					</div>
				...
				<div class="tabContainer">
					<div id="taba" class="block-wrapper intro active">
						<div class="teacherBox">
							...
							<dvi class="infoTxt">
								<p>陳聰富</p>
								<span><em>職稱：教授</em><em>｜</em><em>單位：台灣大學法律學院</em></span>
							</dvi>
							<div class="clearfix"></div>
						</div>
						<div class="introTxt">
							<p>陳教授擅長於民法及醫療法，曾出版「因果關係與損害賠償」、「侵權歸責原則與損害賠償」、「侵權違法性與損害賠償」及「醫療責任的形成與展開」等專書，並著有相關文章七十餘篇。</p>
